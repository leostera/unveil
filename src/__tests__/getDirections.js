...
const getDirections = require('../getDirections').default;
const fixture = require('../components/__tests__/fixtures/RoutesMap').default;

describe('GetDirections', () => {
  describe('directions', () => {
    let t = (name, state, level, direction, result) => it(name, () => {
      let directions = getDirections(state, fixture());
